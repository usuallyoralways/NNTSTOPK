...
public class Constant {
	...
	public static String topKPath = "F:/lijun/code/wwwsj/NN-TS/data/dataset/tao_topk_190916.txt";
	public static String topKcoll = "F:/lijun/code/wwwsj/NN-TS/data/dataset/Mnist.txt";
