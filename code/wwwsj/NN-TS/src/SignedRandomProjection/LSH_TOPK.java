...
public class LSH_TOPK {
    ...
    public void parseArguments() {
        ...
        if (datasetFile != null) {
            dataset = LSH.readDataset(datasetFile, Integer.MAX_VALUE,true);
    ...
    public static void main(String args[]) {
        ...
        args = new String[]{"-f", "l2", "-h", "3", "-n", "10","-t", "5", "-d", Constant.basePath+"Mnist/Mnist.ds", "-q" ,Constant.basePath+"Mnist/Mnist.q"};
        LSH_TOPK cli = new LSH_TOPK(args);
        cli.parseArguments();
